...
public class MyBatisPlusGenerator {
    ...
    private static final String USERNAME = "June";
    ...
    private static final String BASE_PACKAGE = "com.june.user";

    /**
     * 数据库信息
     */
    private static final String DATABASE_IP = "rm-cn-4xl3kaims000fumo.rwlb.rds.aliyuncs.com";
    private static final String DATABASE_PORT = "3306";
    private static final String DATABASE_NAME = "train";
    private static final String DATABASE_USERNAME = "train";
    private static final String DATABASE_PASSWORD = "Qq1243134432";
